...
$_location/pole $_common --AGENT_GROUP_SIZE=1 --TIME_STEPS=65536 --TEST_INTERVAL=65536
...
$_location/pole $_common --AGENT_GROUP_SIZE=4 --TIME_STEPS=32768 --TEST_INTERVAL=2048
...
$_location/pole $_common --AGENT_GROUP_SIZE=16 --TIME_STEPS=32768 --TEST_INTERVAL=2048
...
_common="$_trials $_run $_grpsize $_restart $_test $_sharing $_parms $_wgtinfo"
$_location/pole $_common --AGENT_GROUP_SIZE=256 --TIME_STEPS=1024 --TEST_INTERVAL=1024
